...
class ConfirmReservationUseCase(private val repository: BookingConfirmationRepository) {
    suspend operator fun invoke(parkingId: Int, driverId: Int, duration: Int, paymentMethod: String, clientName: String): Int? {
        return repository.makeReservation(parkingId, driverId, duration, paymentMethod, clientName)
    }
}